...
<html lang="ja">
  ...
  <body>
    <header id="header">
      <h1 class="site-title"><img src="../images/banner3.png" alt="Mag88"></h1>
    </header>
    ...
    <main>
      <section id="magazine" class="wrapper">
        ...
        <div class="flex-item">
          <a class="item" href="#">
            <img src="../images/banner2.png" alt="テキストテキストテキストテキスト">
            <div class="text">
    ...
    <footer id="footer">
      <div class="flex-item wrapper">
        <div class="item">
          <a href="index.html"><img src="../images/banner6.png" alt="Mag88"></a>
        </div>
        <div class="item">
